...
def rename_ckpt():
    ...
    reader = tf.train.NewCheckpointReader(
        "/home/widiot/workspace/tensorflow-space/tensorflow-gpu/practices/im2txt/model/model.ckpt-2000000"
    )
    ...
    with tf.Session() as sess:
        ...
        saver.save(
            sess,
            "/home/widiot/workspace/tensorflow-space/tensorflow-gpu/practices/im2txt/model/newmodel.ckpt-2000000"
        )
